...
functions-framework --debug \
    --target generate_current_assessment_chart_configs
 # --target generate-assessment-chart-configs
 # --target generate_assessment_chart_configs

gcloud functions deploy generate-current-assessment-chart-configs \
--region=us-east4 \
--runtime=python312 \
--source=. \
--entry-point=generate_current_assessment_chart_configs \
...
gcloud functions call generate-current-assessment-chart-configs --region=us-east4 --gen2
